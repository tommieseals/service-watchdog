...
class ServiceMonitor:
    ...
    def _check_process_name(self, status: ServiceStatus) -> ServiceStatus:
        ...
        attrs = ["name", "pid", "cpu_percent", "memory_info", "create_time"]
    ...
    def _check_pid_file(self, status: ServiceStatus) -> ServiceStatus:
        ...
        if self.config.pid_file is None:
            status.error = "No pid_file configured"
            return status
    ...
    def _check_health_url(self, status: ServiceStatus) -> ServiceStatus:
        ...
        if self.config.health_url is None:
            status.error = "No health_url configured"
            return status
